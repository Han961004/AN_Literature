...
import com.project.view.post.list.PostListActivity
import com.project.view.feedback.FeedbackListActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var mainUserInfo : MainUserInfo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainUserInfo = MainUserInfo(headerView) // MainUserInfo 인스턴스 생성, 헤더뷰 참조
        ...
        lifecycleScope.launch {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    userDetail?.let {
                        mainUserInfo.setUserInfo(it.nickname, it.postCount)
                    }
                } else {
